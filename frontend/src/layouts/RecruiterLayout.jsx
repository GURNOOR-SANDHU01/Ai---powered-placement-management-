...
const RecruiterLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'Create Job', path: '/recruiter/create-job', icon: <PlusCircle size={20} /> },
    { name: 'Manage Jobs', path: '/recruiter/manage-jobs', icon: <Briefcase size={20} /> },
    { name: 'Applications', path: '/recruiter/applications', icon: <Users size={20} /> },
    { name: 'Interviews', path: '/recruiter/interviews', icon: <Calendar size={20} /> },
  ];
      ...
      <aside className="w-64 bg-card border-r border-border hidden md:flex flex-col">
        <div className="h-16 flex items-center px-6 border-b border-border">
          <Link to="/recruiter" className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl tracking-tight">Recruiter Portal</span>
          </Link>
        </div>
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <header className="h-16 bg-card border-b border-border flex items-center justify-between px-6 shrink-0 z-10 glass">
          <div className="flex items-center md:hidden">
            <span className="font-bold text-lg">Recruiter Portal</span>
          </div>
          ...
          <div className="ml-auto flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-border">
              ...
              <div className="hidden sm:block text-sm">
                <p className="font-medium text-foreground leading-none">Acme Corp</p>
                <p className="text-muted-foreground text-xs mt-1">Hiring Manager</p>
              </div>
            </div>
          </div>
        </header>
